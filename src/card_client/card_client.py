...
class CardClient:
    ...
    def __init__(self):
        ...
        self.names = ["Alice Smith", "Bob Jones", "Charlie Brown", "Diana Lee", "Ahmed Khan"]
    ...
    def generate_card(self):
        ...
        try:
            ...
            logging.warning(f"Invalid card: {e}")
        self.cards.append(card)
        logging.info(f"Generated: {card}")
        return card

    def publish_cards(self, count=25, topic="kyc/card_data"):
        try:
    ...
    def close(self):
        ...
        logging.info("CardClient closed")
